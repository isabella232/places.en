...
description: Create a library by using the Experience Platform Location Service REST API.
seo-description: Create a library by using the Experience Platform Location Service REST API.
---
