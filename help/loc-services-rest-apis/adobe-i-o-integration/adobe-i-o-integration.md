...
Each request to the Experience Platform Location Service REST API requires the following items:
...
* To create an integration for Experience Platform Location Service, see [Creating a Experience Platform Location Service integration](/help/loc-services-rest-apis/adobe-i-o-integration/create-a-loc-services-integration.md).
...
>[!IMPORTANT]
>
>If you cannot log in to the Adobe I/O console, or if Experience Platform Location Service is not an option on the *Create Integrations page*, see [Organization requirements](/help/loc-services-rest-apis/organizational-requirements.md).
