...
5. In the Admin Console, if you have access to several organizations, verify that the correct organization is selected in the top right side of the page. This is the organization to which you will add your users. If the correct org has not been selected, click on the org, and select the org from the drop-down list. If you have access to several organizations, verify that the correct org is selected.  
...
2. Select the correct profile:
   ...
   c. Click **Edit** next to **[!UICONTROL Property Rights]**.
...
1. For users who also need access to the Places REST API, you need to add them as a Developer.
   ...
   * Click the dot on the right so **[!UICONTROL Assign Developers]** appears at the bottom of the card.
   ...
   b. Click **[!UICONTROL + Assign Developers]**.
